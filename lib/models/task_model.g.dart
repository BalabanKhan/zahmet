...
const TaskModelSchema = CollectionSchema(
  name: r'Task',
  id: 2998003626758701, // Trimmed for JS safe int
  properties: {
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> isPostponedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isPostponed',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> snoozeCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> snoozeCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByIsPostponed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPostponed', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByIsPostponedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPostponed', Sort.desc);
    });
  }
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortBySnoozeCountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByIsPostponed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPostponed', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByIsPostponedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPostponed', Sort.desc);
    });
  }
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenBySnoozeCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'snoozeCount', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByIsPostponed() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isPostponed');
    });
  }
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, bool, QQueryOperations> isPostponedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isPostponed');
    });
  }
  ...
  QueryBuilder<TaskModel, int, QQueryOperations> snoozeCountProperty() {
    return QueryBuilder.apply(this, (query) {
